...
class nso_tif_kernel_iterator_generator:
    ...
    def sample_pixels(self,amount = 100):
        ...
        while len(return_samples) < amount:
            ...
            try:
                return_samples.append(self.get_pixel_value(permutations[x_samp][0], permutations[x_samp][1]))
    ...
    def sample_kernels(self,amount = 100):
        ...
        while len(return_samples) < amount:
            ...
            try:
                return_samples.append(self.get_kernel_for_x_y(permutations[x_samp][0], permutations[x_samp][1]))
